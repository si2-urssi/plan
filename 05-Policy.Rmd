...
7. Increase the diversity of the development and maintenance community to acheive the diversity of the overall US population.
...
#### Ihe impact of individuals (Aim 2)

**The impact of individuals policy - research actions**:
...
**Disentangle quality and impact of software policy advocacy actions**:
...
#### General advocacy actions (not mapped to specific Aims)
...
**Staff career path policy research actions (Aim 1)**:
...
**Incentivize contributions to public software policy advocacy actions (Aim 3)**:

* Run a help desk once a week on-line for people who are running into difficulties in making contributions and need help

**Disentangle quality and impact of software policy research actions (Aim 4)**:
...
**Recognize the value and importance of software policy research actions (Aim 5)**:

* Study whether higher-quality software produces higher-impact science or more reliable science results

**Funding opportunities for software maintenance policy advocacy actions (Aim 6)**:
