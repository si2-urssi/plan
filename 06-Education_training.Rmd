...
that the education in most disciplines that require software skills does not actually include
educational components discussing software. As a result, there are valuable 
...
Indeed, previous studies demonstrate that researchers are rarely purposely trained to develop software. A  
...
use and training from the UK repeats this finding: In 2014, Heatrick et al. asked 
...
efforts through the following planned activities (more detail provided below): 
...
was quite beneficial to answer specific questions from the students.
...
(5) peer review of code, (6) open science principles, and (7) software citation. 
...
The instructors will be available during this afternoon time to help participants as 
...
either to use the code, add to the code, or both. This is the point when the code 
needs to be converted into a more formal project, both to ensure quality as others 
...
researchers need for making choices about which practices are most relevant 
...
individuals to contribute to this activity. In other words, while URSSI will drive it and encourage 
...
external funding sources. In addition to operating the service, URSSI and partners will need 
...
software engineering and software development, and there is a large literature on the
topic. On the other hand, it is not always clear which of these practices 
are relevant for use in developing research software, most notably because of the different
incentive structure for developers in the research arena. It is also not always clear which aspects 
...
We can do so because our target audience is a subset of that on which the Carpentries
focus.
...
these experiences, and summarize and document the results, as well as the travel for the team to meet with members of research projects.
