...
needs are training in data integration, data management, and scaling analyses for HPC [@Barone2017]. 
...
[@10.12688/f1000research.3-62.v2; @softwarecarpentryhistory] about the history of Software Carpentry:
...
for emerging practices from other domain-specific software institutes (e.g., MolSSI, SGCI, IRIS-HEP) 
...
we identified the following topics as candidates for inclusion in such a school: (1) human 
factors in the software development process, (2) peer code review, (3) modern version 
control (i.e., git), (4) software design, (5) software testing, (6) open science principles, 
and (7) software citation. 
...
(1) Requirements solicitation, (2) Agility, (3) Issue tracking, (4) Source control, (5) Testing, 
(6) Documentation, (7), Pair programming, (8) Code review, (9) Metrics, and (10) Estimating 
Developer Time. Note that there is some overlap between the focus of Research Project Carpentry 
